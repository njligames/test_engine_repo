...
SDLGameInterface *gInterface = SDLGameInterface::getInstance();

#include "TestGame.h"
//gInterface->registerGame(new TestGame());
//SDLGameInterface::getInstance()->registerGame(new TestGame());
...
static std::unique_ptr<Graphics> gGraphics;
