...
void TreasureHuntRenderer::DrawFloor() {
    ...
    glUniformMatrix4fv(floor_modelview_param_, 1, GL_FALSE, MatrixToGLArray(modelview_).data());
    ...
    glVertexAttribPointer(floor_normal_param_, 3, GL_FLOAT, false, 0, floor_normals_);
    glVertexAttribPointer(floor_color_param_, 4, GL_FLOAT, false, 0, floor_colors_);
...
//                                           audio_source_id_, model_cube_.m[0][3], model_cube_.m[1][3], model_cube_.m[2][3]);
